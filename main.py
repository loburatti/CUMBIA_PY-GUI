"""
CUMBIA_PY 0.3.3 - Advanced GUI Launcher
...
class CumbiaApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(title_bar, text='  CUMBIA_PY 0.3.3', font=('Segoe UI', 16, 'bold')).pack(side='left', padx=10)
