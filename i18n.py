...
_STRINGS = {
    'en': {
        ...
        'msg_not_a_number':   'not a valid number:',
    ...
    'it': {
        ...
        'msg_not_a_number':   'valore non numerico valido:',
        ...
        'about_license':      'Distribuito con licenza MIT',
